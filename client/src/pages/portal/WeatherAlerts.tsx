...
const MOCK_ALERTS: Alert[] = [
  {
    ...
    description: "Tree pollen levels are elevated. Bring allergy medication if needed.",
    date: "2024-03-12",
  },
  {
    id: "2",
    ...
    description: "Wind gusts up to 25 mph expected Wednesday. Secure outdoor plans.",
    date: "2024-03-12",
  },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-gradient-to-br from-cyan-950/30 to-blue-950/30 border-cyan-500/20 p-6">
        <h4 className="text-lg font-semibold mb-4">{selectedForecast.day}'s Forecast</h4>

        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="text-center p-4 bg-black/20 rounded-lg">
            <div className="text-4xl mb-2">{selectedForecast.icon}</div>
            <p className="text-sm text-muted-foreground">{selectedForecast.condition}</p>
          </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="p-3 bg-black/20 rounded-lg">
            ...
            <p className="text-lg font-semibold text-foreground">{selectedForecast.precipitation}%</p>
          </div>
          ...
          <div className="p-3 bg-black/20 rounded-lg">
            ...
            <p className="text-lg font-semibold text-foreground">{selectedForecast.windSpeed} mph</p>
          </div>
        ...
        <div className="mt-4 p-3 bg-black/20 rounded-lg">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {selectedForecast.high > 75 && (
              <Badge variant="outline" className="text-xs">😎 Sunscreen</Badge>
            )}
            {selectedForecast.windSpeed > 12 && (
              <Badge variant="outline" className="text-xs">🧥 Windbreaker</Badge>
            )}
            {selectedForecast.high < 60 && (
              <Badge variant="outline" className="text-xs">🧣 Jacket</Badge>
            )}
          </div>
        </div>
      </Card>
      ...
      <Card className="bg-emerald-950/20 border-emerald-500/20 p-4">
        <h4 className="font-medium text-sm text-emerald-400 mb-2">💡 Pro Tips</h4>
