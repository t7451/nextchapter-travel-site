  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-gradient-to-br from-violet-950/30 to-purple-950/30 border-violet-500/20 p-6">
        <h3 className="text-sm font-medium text-muted-foreground mb-4">Travel Group</h3>
        ...
        {/* Group Notes */}
        <div>
          <label className="text-xs font-medium text-muted-foreground mb-2 block">Group Notes</label>
          <textarea
            value={groupNotes}
      ...
      {showForm && (
        <Card className="p-6 border-border/50">
          <h3 className="text-lg font-semibold mb-4">Invite Travel Companion</h3>
          ...
          <div className="space-y-4">
            ...
            <select
              value={formData.role}
              onChange={(e) => setFormData({ ...formData, role: e.target.value as "organizer" | "companion" })}
            ...
            <div className="flex items-start gap-4 mb-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <h4 className="font-semibold text-foreground">{companion.name}</h4>
                  <Badge
                    variant={companion.role === "organizer" ? "default" : "secondary"}
                    className="text-xs"
                  >
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <a href={`mailto:${companion.email}`} className="text-xs hover:text-primary transition-colors">
                    {companion.email}
                  </a>
                </div>
                ...
                <div className="flex items-center gap-2">
                  {companion.status === "accepted" ? (
                    ...
                    <>
                      ...
                      <span className="text-xs text-yellow-400">Invitation Pending</span>
                    </>
                  ) : (
                    <>
      ...
      <Card className="p-6 border-border/50">
        ...
        <div className="space-y-3">
          <div className="p-3 bg-black/20 rounded-lg">
            <p className="text-xs text-muted-foreground mb-1">Travel Itinerary</p>
          ...
          <div className="p-3 bg-black/20 rounded-lg">
            <p className="text-xs text-muted-foreground mb-1">Shared Documents</p>
            <p className="text-sm font-medium text-foreground hover:text-primary cursor-pointer transition-colors">
      ...
      <Card className="border-blue-500/20 bg-blue-950/20 p-4">
        <h4 className="font-medium text-sm text-blue-400 mb-3">👥 Group Travel Tips</h4>
